...
export const validCard = '4242 4242 4242 4242'.replace(/\s/g, "");
export const withoutFundsCard = '4111 4111 4111 4111'.replace(/\s/g, "");
export const withoutAuthorizationCard = '4000 4000 4000 4000'.replace(/\s/g, "");
